    ...
    <section className='HomeNewsSection'>
      <div className="container">
        <div className='HomeNewsText'>
          ...
          <Link className='allNews' to='/'>Все новости 
        ...
        <div className='row HomeNewsContent'>
          <div className='col-12 col-md-6 col-xl-4'>
            <img src={NewsImg} alt="..." />
            <h2>Интересный конкурс, в котором отобрал юных снайперов</h2>
            <div className='moreNewsContent d-flex justify-content-between'>
